...
import com.pic.cloudpicturebackend.manager.websocket.PictureEditHandler;
    ...
    public void onEvent(PictureEditEvent pictureEditEvent) throws Exception {
        ...
        switch (pictureEditMessageTypeEnum) {
            ...
            default:
                ...
                session.sendMessage(new TextMessage(pictureEditHandler.jsonLongToString(pictureEditResponseMessage)));
                break;
        }
    }
}
